// Belly Button Biodiversity - Bonus
function buildGauge(g_level) {
    ...
    //  Create the path where x is the xpath, and y is the ypath, and z is the end path
    ...
    // Adding the other half of the circle to the values
